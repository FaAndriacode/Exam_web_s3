<footer class="text-center bg-dark fixed-bottom">
        <div class="container text-white py-4 py-lg-5">
            <ul class="list-inline">
                <li class="list-inline-item me-4"><a class="link-light fs-5" href="#">Fandresena ETU 1763</a></li>
                <li class="list-inline-item me-4"><a class="link-light fs-5" href="#">Stephan ETU 1867</a></li>
                <li class="list-inline-item"><a class="link-light fs-5" href="#">Najaina ETU 1847</a></li>
            </ul> 
            <ul class="list-inline">
            ...
            <p class="text-muted mb-0">Copyright © 2023 E-Commerce</p>
        </div>
    </footer>
