                        ...
                        <?php foreach($myObject as $object){ 
                            ...
                            <div class="col-4 p-3">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-3"><a href=" <?php echo site_url("Acceuil/ConfirmChanger/".$ob['id_Object']."/".$id_Object_proprietaire."/".$id_Object.""); ?> " class="btn btn-primary d-block w-100" data-bss-hover-animate="flash" type="submit">Valider</a></div>
                                </div>
                            </div>
                        <?php }
                    } ?>
