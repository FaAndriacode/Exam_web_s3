<div class="container">
        <section class="m-5">
            <div class="row">
                ...
                <div class="col-9">
                <p class="text-warning fs-2">Object des autres utilisateurs</p>
                        ...
                        <?php foreach($myObject as $object){ 
                            ...
                            <div class="col-4 p-3">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-3">
                                        <a href=" <?php echo site_url("Acceuil/Change/".$ob['id_Object']."/".$ob['id_utilisateur_proprietaire'].""); ?> " class="btn btn-primary d-block w-100" data-bss-hover-animate="flash">
                                            Echanger
                                        </a>
                                    </div>
                                </div>
